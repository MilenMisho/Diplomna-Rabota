...
namespace PlaneTicketsApp.Abstractions
{
    public interface IFlightService
    {
       ...
       bool UpdateFlight(int id, int flightnumber, string startingdestination, string endingdestination, DateTime takeoffdateandtime, DateTime landingdateandtime, Plane plane, int priceperticket);
